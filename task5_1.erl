...
benchmark() ->
    ...
    io:format("map\t\t\t\t~10w\t~10w\t~10w\t~10w~n", [InsertMap, UpdateMap, DeleteMap, ReadMap]),
    
    %% proplist
    {InsertProplist, UpdateProplist, DeleteProplist, ReadProplist} = measure_proplist(),
    io:format("proplist\t\t\t~10w\t~10w\t~10w\t~10w~n", [InsertProplist, UpdateProplist, DeleteProplist, ReadProplist]),
    
    %% Process Dictionary
    {InsertPD, UpdatePD, DeletePD, ReadPD} = measure_process_dict(),
    io:format("Process Dict\t~10w\t~10w\t~10w\t~10w~n", [InsertPD, UpdatePD, DeletePD, ReadPD]),
    
    %% dict
    {InsertDict, UpdateDict, DeleteDict, ReadDict} = measure_dict(),
    io:format("dict\t\t\t\t~10w\t~10w\t~10w\t~10w~n", [InsertDict, UpdateDict, DeleteDict, ReadDict]),
    
    %% record
    {InsertRecord, UpdateRecord, DeleteRecord, ReadRecord} = measure_record(),
    io:format("record\t\t\t\t~10w\t~10w\t~10w\t~10w~n", [InsertRecord, UpdateRecord, DeleteRecord, ReadRecord]),
    
    %% ETS
    {InsertETS, UpdateETS, DeleteETS, ReadETS} = measure_ets(),
    io:format("ETS\t\t\t\t~10w\t~10w\t~10w\t~10w~n", [InsertETS, UpdateETS, DeleteETS, ReadETS]),
    
    %% DETS
    {InsertDETS, UpdateDETS, DeleteDETS, ReadDETS} = measure_dets(),
    io:format("DETS\t\t\t\t~10w\t~10w\t~10w\t~10w~n", [InsertDETS, UpdateDETS, DeleteDETS, ReadDETS]).
